...
class AndroidTVController:
    ...
    def switch_hdmi(self, hdmi_number: int):
        """Switch to HDMI input - TCL specific function"""

        # source: https://community.home-assistant.io/t/android-tv-hdmi/234411/48
        hw_ids = {
            1: 1413744128,
            2: 1413744384,
            3: 1413744640,
        ...
        if hdmi_number in hw_ids:
            uri = ('content://android.media.tv/passthrough/com.tcl.tvinput%2F.passthroughinput.TvPassThroughService%2FHW{}'.
                   format(hw_ids[hdmi_number]))
            self.__adb_client.start_intent(uri)
